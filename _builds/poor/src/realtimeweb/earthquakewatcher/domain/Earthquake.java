...
public class Earthquake {
	...
	public String toString() {
		return "Report[" +maximumEstimatedIntensity+", "+distance+", "+alertLevel+", "+feltReports+", "+locationDescription+", "+url+", "+time+", "+rootMeanSquare+", "+eventSource+", "+gap+", "+magnitude+", "+location+", "+significance+", "+maximumReportedIntensity+", "+id+"]";
	}
    ...
    public Earthquake(Map<String, Object> raw) {
        ...
        this.maximumEstimatedIntensity = Double.parseDouble(raw.get("properties").get("mmi").toString());
        this.distance = Double.parseDouble(raw.get("properties").get("dmin").toString());
        this.alertLevel = raw.get("properties").get("alert").toString();
        this.feltReports = Integer.parseInt(raw.get("properties").get("felt").toString());
        this.locationDescription = raw.get("properties").get("place").toString();
        this.url = raw.get("properties").get("url").toString();
        this.time = Long.parseLong(raw.get("properties").get("time").toString());
        this.rootMeanSquare = Double.parseDouble(raw.get("properties").get("rms").toString());
        this.eventSource = raw.get("properties").get("status").toString();
        this.gap = Double.parseDouble(raw.get("properties").get("gap").toString());
        this.magnitude = Double.parseDouble(raw.get("properties").get("mag").toString());
        this.location = new Coordinate(raw.get("geometry").get("coordinates"));
        this.significance = Integer.parseInt(raw.get("properties").get("sig").toString());
        this.maximumReportedIntensity = Double.parseDouble(raw.get("properties").get("cdi").toString());
