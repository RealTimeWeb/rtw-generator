package realtimeweb.simpleearthquake;
...
import realtimeweb.simpleearthquake.domain.*;
...
public class SimpleEarthquake {
    ...
    public static void main(String[] args) {
        SimpleEarthquake simpleEarthquake = new SimpleEarthquake();
		...
		try {
			 ...
			 * StickyWebRequest request = SimpleEarthquake.getEarthquakesRequest(...);
     ...
     */
	public SimpleEarthquake(InputStream cache) {
        try {
            this.online = false;
	...
	public ArrayList<Earthquake> getEarthquakes(String threshold, String time) {
        try {
            ...
            if (response.isNull())
                return result;
            Iterator<Object> resultIter = ((ArrayList<Object>) ((Map<String, Object>) response.asJSON()).get("features")).iterator();
            while (resultIter.hasNext()) {
                result.add(new Earthquake((Map<String, Object>)resultIter.next()));
            }
            return result;
