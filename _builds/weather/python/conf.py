...
copyright = u'2013, Austin Cory Bart'
...
texinfo_documents = [
  ('index', 'weatherservice', u'weatherservice Documentation',
   u'Austin Cory Bart', 'weatherservice', 'Get a report of present weather and forecast data.',
   'Miscellaneous'),
]
